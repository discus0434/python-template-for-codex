...
4) Output the Self-Review Summary with OK/GAP/FIX. For GAP/FIX, include severity: Critical/Major/Minor/Info, and cite concrete file paths and plan sections when possible.
Then exit.
```
